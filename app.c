...
static uint8_t CONNECT_TIMEOUT_SEC = 100;
    ...
    case sl_bt_evt_gatt_characteristic_value_id:
      ...
      /* if a temperature value was received from a slave... */
           if (evt->data.evt_gatt_characteristic_value.att_opcode
             ...
             app_log("%u  ",evt->data.evt_gatt_characteristic_value.value.data[0]);
             app_log("%u  ",evt->data.evt_gatt_characteristic_value.value.data[1]);
             app_assert_status(sc);
           }
           led_7seg_display_number( evt->data.evt_gatt_characteristic_value.value.data[0]);
           break;
